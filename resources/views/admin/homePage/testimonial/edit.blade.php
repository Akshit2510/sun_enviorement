                ...
                <div class="widget-content widget-content-area">
                    <form action="{{route('testimonial.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group  mb-4">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter Title"  required="required" value="{{$testimonial['title']}}">
                        </div>
                        
                        <div class="form-group  mb-4">
                            <label for="banner_images">Type</label>
                            <input type="text" class="form-control" name="type" id="type" placeholder="Enter Type"  required="required" value="{{$testimonial['type']}}">
                        </div>

                        <div class="form-group mb-4">
                            <label for="banner_images">Description </label>
                            <textarea class="form-control" name="description" id="description" placeholder="Enter Testimonial Description" required="required">{{$testimonial['description']}}</textarea>
                        </div>
                        ...
                        <div class="form-group mb-4" id="imageUploadSection">
                            ...
                            <img class="imagePreview" src="{{ url('/').'/'.$testimonial['image']}}" class="d-none" alt="Preview Image" style="max-width: 200px; max-height: 200px;">
                        </div>
