    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row page-meta">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <a href="{{ route('testimonial.create') }}" class="btn btn-primary mr-2"> Add </a>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="banner_images" name="banner_images" accept="image/*">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_banner_image"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader btn-loader spin me-2"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg> Save</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submit_banner_image').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            $('.alert-success').text('Image uploaded successfully').show();
                            // dataTable.ajax.reload();
                            window.location.reload();
                        } else {
                            // Handle unsuccessful response
                            $('.alert-success').text('uploaded failed').show();
            ...
            $(document).on('click', '.testimonialDeleteBtn', function(e) {
                ...
                var deleteUrl = '{{ route("delete.testimonial", ":itemId") }}'; // URL template
        ...
        var dataTable = $('.zero-config').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('testimonialDatatable') }}",
            "columns": [
                { "data": "id" },
                { "data": "image" },
                { "data": "title" },
