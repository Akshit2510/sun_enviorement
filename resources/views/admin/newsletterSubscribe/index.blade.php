    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row page-meta">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <a href="{{route('page.create')}}" class="btn btn-primary mb-2 me-4">Add Record</a>
            </div> --}}
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
...
<!-- Add this jQuery code within a <script> tag at the end of your Blade template -->
    ...
    <script src="{{ asset('backend_assets/src/plugins/src/table/datatable/button-ext/dataTables.buttons.min.js')}}"></script>
    <script src="{{ asset('backend_assets/src/plugins/src/table/datatable/button-ext/jszip.min.js')}}"></script>
    <script src="{{ asset('backend_assets/src/plugins/src/table/datatable/button-ext/buttons.html5.min.js')}}"></script>
    <script src="{{ asset('backend_assets/src/plugins/src/table/datatable/button-ext/buttons.print.min.js')}}"></script>
    {{-- <script src="{{ asset('backend_assets/src/plugins/src/table/datatable/custom_miscellaneous.js')}}"></script> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            "<'dt--bottom-section d-sm-flex justify-content-sm-between text-center'<'dt--pages-count  mb-sm-0 mb-3'i><'dt--pagination'p>>",
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('newsletterSubscribe.data') }}",
                "columns": [
                    { "data": "email" },
                    { "data": "created_at" },
                ],
