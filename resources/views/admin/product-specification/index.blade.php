    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row page-meta">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <a href="{{ route('product-specification.create') }}" class="btn btn-primary mr-2"> Add </a>
            </div>
...
<!-- Add this jQuery code within a <script> tag at the end of your Blade template -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.PSDeleteBtn', function(e) {
                emptyError();
                ...
                var deleteUrl = '{{ route("delete.product-specification", ":itemId") }}'; // URL template
        ...
        var dataTable = $('.zero-config').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('product-specification-data') }}",
            "columns": [
                { "data": "id" },
                { "data": "title" },
                { "data": "status" },
