    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row page-meta">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <a href="{{ route('product.create') }}" class="btn btn-primary mr-2">Add</a>
            </div>
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.productDeleteBtn', function(e) {
                ...
                console.log(this);
                var $btn = $(this);
                var productId = $(this).attr('id'); // Get the ID of the item to delete
                var deleteUrl = '{{ route("product.destroy", ":productId") }}'; // URL template
                // Replace the placeholder with the actual item ID
                deleteUrl = deleteUrl.replace(':productId', productId);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.alert-danger').text('Record Deleted successfully').show();
